...
// Seeded pilot operator is emp_code 3000 / PIN 5678 (seed-pilot-users.mjs).
...
const pin = (process.env.SMOKE_PIN || (isCi ? '' : '5678')).trim();

if (!badge || !pin) {
  throw new Error(
    'SMOKE_BADGE_ID and SMOKE_PIN are required (seeded badge e.g. 3000 / PIN 5678). ' +
