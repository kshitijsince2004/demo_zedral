...
echo "  4. Optional one-time seed after first pull: docker compose -f deploy/docker-compose.prod.yml --env-file deploy/.env exec backend node scripts/seed-login-profiles.mjs"
