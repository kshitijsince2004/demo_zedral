...
CREATE TABLE IF NOT EXISTS txn.shift_override_audit (
...
CREATE TABLE IF NOT EXISTS txn.order_shift_attribution (
...
CREATE TABLE IF NOT EXISTS txn.shift_event_audit (
...
CREATE INDEX IF NOT EXISTS ix_shift_event_audit_type ON txn.shift_event_audit (event_type, created_at DESC);
